...
namespace RowThon
{
    ...
    public class DelegateCommand : ICommand
    {
		...
		///     Constructor
		/// </summary>
		public DelegateCommand(Action<object> executeMethod, object obj, Func<bool> canExecuteMethod)
		...
		public DelegateCommand(Action<object> executeMethod, Func<bool> canExecuteMethod, bool isAutomaticRequeryDisabled)
		{
			...
			_executeMethodArg = executeMethod;
			_canExecuteMethod = canExecuteMethod;
			_isAutomaticRequeryDisabled = isAutomaticRequeryDisabled;
		}
        ...
        public void Execute()
        {
			...
			if( _executeMethodArg != null ) {
				_executeMethodArg(_argObject);
			}
        }
		public void Execute(object obj)
		{
			if( _executeMethodArg != null ) {
				_executeMethodArg(obj);
			}
		}
		...
		private readonly Action<object> _executeMethodArg = null;
		private object _argObject = null;
